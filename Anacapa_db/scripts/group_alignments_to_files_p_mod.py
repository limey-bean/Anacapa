...
class BowtieSorter(object):
    ...
    def __init__(self, directory, entry2, entry3, good_file_name='bowtie2_good_hits.txt',  
        ...
        self.max_allowable_cigar_s = entry2
        self.identity_cutoff_to_keep = float(entry3)
