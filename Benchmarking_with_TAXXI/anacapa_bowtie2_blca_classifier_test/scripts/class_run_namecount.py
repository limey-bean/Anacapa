...
Usage = '''
python2 run_namecount.py tax_test.txt ./namecounts tax_test

tax_test.txt is the input file
./namecounts is the output directory
and tax_test is the name of the output file prefix
'''
